          ...
          <div className="space-y-8 flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-[#1877F2] flex items-center justify-center text-white hover:scale-110 hover:shadow-[0_0_15px_rgba(24,119,242,0.4)] transition-all focus:outline-none focus:ring-2 focus:ring-white"
                aria-label="Facebook"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
